...
cc_library(
    ...
    srcs = [
        ...
        "src/cpp/fastdds/builtin/type_lookup_service/detail/rpc_typesCdrAux.ipp",
        "src/cpp/fastdds/builtin/type_lookup_service/detail/TypeLookupTypesPubSubTypes.cxx",
        "src/cpp/fastdds/builtin/type_lookup_service/detail/TypeLookupTypesCdrAux.ipp",
        ...
        "src/cpp/fastdds/xtypes/type_representation/dds_xtypes_typeobjectCdrAux.ipp",
